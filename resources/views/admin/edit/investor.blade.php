...
@section("content")
    <main class="h-screen pt-4 bg-bg1 bg-cover">
        ...
        <div class="flex mx-8 mt-8 gap-8">
            ...
            <form action="/editinvestor/{{$investor->id}}" method="POST"
                    ...
                    <div class="flex flex-col gap-2 w-1/2">
                        ...
                        <div>
                            ...
                            <select class="form-input w-full" name="gender" id="gender">
                                ...
                                <option value="L" @if($investor->gender === "L") selected @endif>Laki-laki</option>
                                <option value="P" @if($investor->gender === "P") selected @endif>Perempuan</option>
                            </select>
                    ...
                    <div class="flex flex-col gap-2 w-1/2">
                        ...
                        <div>
                            ...
                            <input class="form-input w-full" type="text" name="kecamatan" id="kecamatan"
                                   placeholder="Kecamatan" value="{{$investor->kecamatan}}">
                        ...
                        <div>
                            ...
                            <input class="form-input w-full" type="text" name="kabupaten" id="kabupaten"
                                   placeholder="Kabupaten" value="{{$investor->kabupaten}}">
                        ...
                        <div>
                            ...
                            <input class="form-input w-full" type="text" name="provinsi" id="provinsi"
                                   placeholder="Kecamatan" value="{{$investor->provinsi}}">
                ...
                <div>
                    ...
                    <a href="/akuninvestor" class="btn btn-secondary px-12">Batal</a>
                </div>
            </form>
        </div>
    </main>
